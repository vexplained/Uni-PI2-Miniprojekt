 ...
 */
public class DynCompoundShape extends DynamicShape
{

	Set<DynamicObject> objSet;

	public DynCompoundShape(Color color, double x, double y)
	{
		super(color, x, y);
	...
	{
		// Do nothing; do NOT call #_draw to circumvent drawing twice
		return;
	}
